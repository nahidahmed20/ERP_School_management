...
class ProductionReadinessCheck extends Command
{
    ...
    public function handle(): int
    {
        $checks = [
            ...
            ['Backup disk writable', $this->writableBackupDisk(), 'local disk'],
        ];
    ...
    {
        try { Storage::disk('local')->put('backups/.readiness', now()->toIso8601String()); Storage::disk('local')->delete('backups/.readiness'); return true; }

...
class MenuOrderService
{
    ...
    private const CHILDREN = [
        ...
        'library' => ['admin.library.catalogue.index', 'admin.library-issues.index'],
        'transport' => ['admin.transport.routes.index', 'admin.vehicles.index', 'admin.transports.index'],
        'hostel' => ['admin.hostel-rooms.index', 'admin.hostel-allocations.index', 'admin.hostel-fees.index'],
        'cafeteria' => [

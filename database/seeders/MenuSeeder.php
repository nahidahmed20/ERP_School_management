        ...
        $nav = [
            ...
            ['label' => 'System', 'items' => [
                ...
                ['key' => 'saas', 'label' => 'SaaS, AI & Backups', 'icon' => 'cloud', 'count' => 7, 'children' => [
                    ['key' => 'admin.saas.tenants', 'label' => 'Tenants & Billing', 'route' => 'admin.saas.tenants'],
                    ['key' => 'admin.saas.plans', 'label' => 'Subscription Plans', 'route' => 'admin.saas.plans'],
                    ['key' => 'admin.saas.apikeys', 'label' => 'API Keys & Logs', 'route' => 'admin.saas.apikeys'],
                    ['key' => 'admin.saas.ai', 'label' => 'AI Assistant', 'route' => 'admin.saas.ai'],
                    ['key' => 'admin.saas.backups', 'label' => 'Backups', 'route' => 'admin.saas.backups'],
                    ['key' => 'admin.saas.tasks', 'label' => 'Scheduled Tasks', 'route' => 'admin.saas.tasks'],
                    ['key' => 'admin.saas.queue', 'label' => 'Queue Monitor', 'route' => 'admin.saas.queue'],
                ]],

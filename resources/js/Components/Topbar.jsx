...
export default function Topbar({ onHamburgerClick }) {
    ...
    return (
        <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200/80 flex items-center justify-between px-6 sticky top-0 z-40 shadow-sm transition-all">
            ...
            <div className="flex items-center gap-3">
                ...
                {/* Language Selector */}
                <select className="appearance-none bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 text-xs font-bold px-3.5 py-2 rounded-xl uppercase tracking-wider outline-none cursor-pointer transition-all shadow-sm">
                ...
                <select
                    ...
                    className="appearance-none bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 text-indigo-700 text-xs font-bold px-3.5 py-2 rounded-xl uppercase tracking-wider outline-none cursor-pointer transition-all shadow-sm max-w-[150px] sm:max-w-none truncate"
                >
                ...
                <Dropdown>
                    <Dropdown.Trigger>
                        <div className="flex items-center gap-3 pl-3 sm:pl-4 border-l border-slate-200 cursor-pointer group">
                    ...
                    <Dropdown.Content className="w-48 py-2 rounded-2xl shadow-xl border border-slate-100 mt-2">

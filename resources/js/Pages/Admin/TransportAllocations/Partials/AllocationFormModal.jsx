      ...
      >
        ...
        <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/50 shrink-0 rounded-t-2xl">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">Assign vehicles, routes and fares to users.</p>
          </div>
        ...
        <form onSubmit={submit} className="flex flex-col flex-1 overflow-hidden">
          <div className="p-6 overflow-y-auto space-y-5 flex-1 custom-scrollbar">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                <label className={labelClass}>Pickup Point <span className="text-rose-500">*</span></label>
                <input
                ...
                />
                {errors.pickup_point && <p className="text-rose-500 text-xs mt-1">{errors.pickup_point}</p>}
              </div>

              <div>
                <label className={labelClass}>Monthly Fare (৳) <span className="text-rose-500">*</span></label>
                <input
                  type="number"
                  value={data.monthly_fare}
                  onChange={(e) => setData('monthly_fare', e.target.value)}
                  min="0"
                  step="0.01"
                  required
                  placeholder="0.00"
                ...
                />
                {errors.monthly_fare && <p className="text-rose-500 text-xs mt-1">{errors.monthly_fare}</p>}
              </div>

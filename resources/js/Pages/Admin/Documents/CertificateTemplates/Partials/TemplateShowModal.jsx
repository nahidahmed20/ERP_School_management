    ...
    <div className="mm-modal-overlay" onClick={onClose}>
      <div className="mm-modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '800px', width: '90%' }}>
        <div className="mm-modal-head">
          <h3>Certificate Preview: {item.title}</h3>
        ...
        <div className="mm-modal-body" style={{ padding: '20px', background: '#e2e8f0', display: 'flex', justifyContent: 'center' }}>
          <div style={{
            ...
            <div>
              <h4 style={{ letterSpacing: '3px', textTransform: 'uppercase', color: '#64748b', fontSize: '14px', margin: 0 }}>Certificate of Achievement</h4>
              <h1 style={{ fontSize: '28px', color: '#0f172a', margin: '10px 0 0 0', fontWeight: 'bold' }}>{item.title}</h1>
            </div>

            <div style={{ fontSize: '14px', color: '#334155', lineHeight: '1.8' }}>
              <p style={{ margin: '0 0 10px 0' }}>This is proudly presented to</p>
              <h2 style={{ fontSize: '24px', color: '#4f46e5', borderBottom: '2px solid #cbd5e1', display: 'inline-block', paddingBottom: '5px', margin: '0 0 15px 0' }}>
        ...
        <div className="mm-modal-foot mt-2" style={{ padding: '15px 20px', display: 'flex', justifyContent: 'flex-end', gap: '10px' }}>
          <button className="btn btn-outline" onClick={() => window.print()}><Icon name="printer" /> Print Preview</button>

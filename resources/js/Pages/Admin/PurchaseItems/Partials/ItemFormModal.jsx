                    ...
                    sizes?.map(s => {
                      ...
                      return (
                        <label key={s.id} className="cursor-pointer">
                          ...
                          />
                          <div className={`px-4 py-1.5 rounded-lg border text-sm font-bold transition-all shadow-sm ${isChecked ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-slate-600 border-slate-300 hover:border-indigo-400'}`}>
                            {s.name}
                          </div>
                        </label>
                      );

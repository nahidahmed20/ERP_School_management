    ...
    <AuthenticatedLayout
      header={
        <div className="mod-mast">
          <div>
            <div className="mod-badge">Edit Profile</div>
            <h1 className="mod-title">{student.first_name} {student.last_name}</h1>
            <p className="mod-subtitle">Update the record below — changes save across all three sections at once.</p>
          </div>
          ...
          <div className="mod-layout">
            ...
            <div>
              ...
              <div id="section-personal" ref={el => sectionRefs.current['section-personal'] = el} className="mod-card">
                ...
                <div className="mod-grid">
                  <div className="mod-field">
                    ...
                    <input className={`mod-input ${errors.first_name ? 'mod-input-error' : ''}`} type="text" value={data.first_name} onChange={e => setData('first_name', e.target.value)} required />
                    {errors.first_name && <span className="mod-error-text">{errors.first_name}</span>}
                  </div>
                  <div className="mod-field">
                    <label className="mod-label">Last Name</label>
                    <input className="mod-input" type="text" value={data.last_name} onChange={e => setData('last_name', e.target.value)} />
                  ...
                  <div className="mod-field">
                    ...
                    <input className="mod-input mono" type="text" value={data.birth_certificate_no} onChange={e => setData('birth_certificate_no', e.target.value)} />
                  ...
                  <div className="mod-field">
                    ...
                    <input className="mod-input mono" type="text" value={data.national_id} onChange={e => setData('national_id', e.target.value)} />
                  ...
                  <div className="mod-field">
                    ...
                    <input className="mod-input" type="text" value={data.religion} onChange={e => setData('religion', e.target.value)} />
                  ...
                  <div className="mod-field">
                    <label className="mod-label">Phone</label>
                    <input className="mod-input mono" type="text" value={data.phone} onChange={e => setData('phone', e.target.value)} />
                    {errors.phone && <span className="mod-error-text">{errors.phone}</span>}
                  </div>
                  <div className="mod-field">
                    <label className="mod-label">Email</label>
                    <input className="mod-input" type="email" value={data.email} onChange={e => setData('email', e.target.value)} />
                  ...
                  <div className="mod-field span-2">
                    ...
                    <textarea className="mod-input" value={data.previous_school_details} onChange={e => setData('previous_school_details', e.target.value)} />
                  ...
                  <div className="mod-field span-2">
                    ...
                    <textarea className="mod-input" value={data.medical_history} onChange={e => setData('medical_history', e.target.value)} />
                  ...
                  <div className="mod-field span-2">
                    ...
                    <textarea className={`mod-input ${errors.present_address ? 'mod-input-error' : ''}`} value={data.present_address} onChange={e => setData('present_address', e.target.value)} required />
                  ...
                  <div className="mod-field span-2">
                    ...
                    <textarea className={`mod-input ${errors.permanent_address ? 'mod-input-error' : ''}`} value={data.permanent_address} onChange={e => setData('permanent_address', e.target.value)} required />
              ...
              <div id="section-guardian" ref={el => sectionRefs.current['section-guardian'] = el} className="mod-card">
                ...
                <div className="mod-grid">
                  ...
                  <div className="mod-field">
                    ...
                    <input className={`mod-input mono ${errors.father_phone ? 'mod-input-error' : ''}`} type="text" value={data.father_phone} onChange={e => setData('father_phone', e.target.value)} required />
                  ...
                  <div className="mod-field">
                    ...
                    <input className="mod-input mono" type="text" value={data.mother_phone} onChange={e => setData('mother_phone', e.target.value)} />
                    {errors.mother_phone && <span className="mod-error-text">{errors.mother_phone}</span>}
                  </div>
                  <div className="mod-field">
                    <label className="mod-label">Guardian Email</label>
                    <input className="mod-input" type="email" value={data.guardian_email} onChange={e => setData('guardian_email', e.target.value)} />
              ...
              <div className="mod-footer">
                ...
                <button type="submit" className="mod-btn-submit" disabled={processing}>
                  <CheckMark />
